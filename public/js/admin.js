...
function renderLists() {
  ...
  (state.data.experience || []).forEach(item => {
    ...
    ], item, removeItem => removeItem.remove());
...
function initializeEvents() {
  ...
  document.getElementById('add-statistic').addEventListener('click', () => {
    ...
    const card = createListItem([
      ...
      { name: 'value', label: 'Value' },
      { name: 'description', label: 'Description', type: 'textarea' }
    ], { label: '', value: '', description: '' }, item => item.remove());
  ...
  document.getElementById('add-experience').addEventListener('click', () => {
    ...
    const card = createListItem([
      ...
      { name: 'description', label: 'Description', type: 'textarea' },
      { name: 'technologies', label: 'Technologies (comma separated)' }
    ], { company: '', role: '', startDate: '', endDate: '', description: '', technologies: '' }, item => item.remove());
    list.appendChild(card);
  });
  ...
  document.getElementById('add-training').addEventListener('click', () => {
    ...
    const card = createListItem([
      ...
      { name: 'description', label: 'Description', type: 'textarea' },
      { name: 'technologies', label: 'Technologies (comma separated)' }
    ], { title: '', organization: '', duration: '', description: '', technologies: '' }, item => item.remove());
    list.appendChild(card);
  });
  ...
  document.getElementById('add-project').addEventListener('click', () => {
    ...
    const card = createListItem([
      ...
      { name: 'image', label: 'Image Path' },
      { name: 'architecture', label: 'Architecture Description', type: 'textarea' }
    ], { title: '', projectNumber: '', shortDescription: '', description: '', technologies: '', github: '', liveDemo: '', featured: false, image: '', architecture: '' }, item => item.remove());
    list.appendChild(card);
  });
  ...
  document.getElementById('add-certification').addEventListener('click', () => {
    ...
    const card = createListItem([
      ...
      { name: 'date', label: 'Date' },
      { name: 'credentialUrl', label: 'Credential URL' }
    ], { name: '', issuer: '', date: '', credentialUrl: '' }, item => item.remove());
    list.appendChild(card);
  });
  ...
  document.getElementById('add-education').addEventListener('click', () => {
    ...
    const card = createListItem([
      ...
      { name: 'graduationYear', label: 'Graduation Year' },
      { name: 'description', label: 'Description', type: 'textarea' }
    ], { degree: '', institution: '', startYear: '', graduationYear: '', description: '' }, item => item.remove());
    list.appendChild(card);
  });
  ...
  document.getElementById('reset-social').addEventListener('click', () => setFormValues(document.getElementById('social-form'), state.data.socialLinks));
  ...
  document.getElementById('reset-settings').addEventListener('click', () => setFormValues(document.getElementById('settings-form'), state.data.settings));
}
